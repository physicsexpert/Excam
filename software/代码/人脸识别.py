...
while True:
    ...
    # Capture snapshot
    img = sensor.snapshot()
    img_processed = img.scale(x_scale=SCALE_X, y_scale=SCALE_Y, hint=image.ROTATE_180)
    # Find objects.
    ...
    # Draw objects
    for r in objects:
        img.draw_rectangle(r,color=0xF800,thickness=3)


    # Print FPS.
    # Note: Actual FPS is higher, streaming the FB makes it slower.
    print(clock.fps())
    img_processed = img.scale(x_scale=SCALE_X, y_scale=SCALE_Y, hint=image.ROTATE_270)
